        ...
        @for (band of bands; track band) {
          @if (readonly()) {
            ...
            <div
              ...
              [class.w-16]="!compact()"
              [class.h-12]="!compact()"
              [class.md:w-20]="!compact()"
              [class.md:h-14]="!compact()"
              [class.w-8]="compact()"
              [class.h-6]="compact()"
            >
              <svg
                ...
                [class.drop-shadow-[0_0_8px_rgba(234,179,8,0.6)]="isActive(band)"
              ...
              >
                <path
                  ...
                  [class.fill-gold-500]="isActive(band)"
                  [class.fill-zinc-800]="!isActive(band)"
